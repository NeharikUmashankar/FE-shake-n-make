  ...
  return (
    <View className="w-full">
      <View className="flex-row h-fit justify-around w-96 mb-3 p-1">
        <ImageViewer
          className=""
          placeholderImageSource={{ uri: "https://freesvg.org/img/bar-15.png" }}
          logo={true}
        ></ImageViewer>
        ...
        >
          <ImageViewer
            placeholderImageSource={
              typeof loggedUser !== "object"
                ? {
                    uri: "https://images.macrumors.com/t/n4CqVR2eujJL-GkUPhv1oao_PmI=/1600x/article-new/2019/04/guest-user-250x250.jpg",
                  }
                : loggedUser.avatar
